...
parser.add_argument("--log_path", type=str, default="2024-11-28_13-45-42\\model_1850.pt", help="Model to be import")
...
def main():
	...
	while simulation_app.is_running():
		with torch.inference_mode():
			...
			# print(mdp.generated_commands(env.unwrapped, "dataset")["dof_pos"][:,14:16],
